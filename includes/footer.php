...
<footer class="footer clearfix" role="contentinfo">
	<div class="container">
				...
				<div class="tabholder">
					...
					<div id="panel3" class="panel accordian" aria-labeledby="tab3" role="tabpanel">
						<ul>
							...
							<li><a href="#">Textbook Rental</a></li>
							<li><a href="#">Faculty Adoption</a></li>
						</ul>
					</div>
				</div>
				<div class="tabholder">
				...
				<div class="tabholder">
					...
					<div id="panel1" class="panel accordian" aria-labeledby="tab1" role="tabpanel">
						<ul>
							...
							<li><a href="#">Request a Catalog</a></li>
							<li><a href="#">Textbook Information</a></li>
		...
		<div class="clearfix footer-bot">
			<p class="copyright">
			&copy; 2015 The University of Iowa. All rights reserved. <a href="#">Privacy Policy</a>.
			</p>
