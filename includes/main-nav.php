	...
	<ul class="main-nav clearfix">
		<li class="first"><a href="#">Textbooks</a>
			<ul>
				...
				<li><a href="#">Faculty Adoptions</a></li>
		...
		<li><a href="#">Men</a>
			<ul>
				...
				<li><a href="#">Business Casual</a></li>
		...
		<li><a href="#">Home &amp; Office</a>
			<ul>
				<li><a href="#">Blankets &amp; Bedding</a></li>
		...
		<li><a href="#">Gifts</a>
			<ul>
				...
				<li><a href="#">Signs &amp; Posters</a></li>
				<li><a href="#">Tailgating Essentials</a></li>
			</ul>
		</li>
