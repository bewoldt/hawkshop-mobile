<nav id="dawgdrops" role="navigation" aria-label="Main menu">
	<ul class="nav-menu">
		<li class="nav-item">
		...
		<li class="nav-item">
			...
			<div class="sub-nav groups group-4">
				<ul class="sub-nav-group">
					...
					<li><a href="http://www.hawkshop.com/ePOS/form=shared3/gm/browse.html&cat=399&amp;design=p3">Shop by Brand</a></li>
				</ul>
				<ul class="sub-nav-group">
					<li>
			...
			<div class="sub-nav groups group-4">
				...
				<ul class="sub-nav-group featured">
					<li>
						<div class="inner">
							<h4>25% Off</h4>
							<p>Women's Polos and dress shirts. <a href="#">Shop Now</a></p>
							<a href="#"><img src="images/MW0291-m.jpg" alt="" class="sub-nav-img"></a>
						</div>
					</li>
				</ul>
			</div>
		...
		<li class="nav-item">
			<a href="http://www.hawkshop.com/ePOS/form=shared3/gm/browse.html&cat=252&amp;design=p3">Kids</a>
			<div class="sub-nav groups group-2">
				...
				<ul class="sub-nav-group featured">
					<li>
						<div class="inner">
							<h4>Youth Girls Striped Dress</h4>
							<p><a href="#">Shop Now</a></p>
							<a href="#"><img src="images/Y0829-m.jpg" alt="" class="sub-nav-img"></a>
						</div>
					</li>
				</ul>
			</div>
		...
		<li class="nav-item">
			...
			<div class="sub-nav groups group-2">
				<ul class="sub-nav-group">
					...
					<li><a href="http://www.hawkshop.com/ePOS/form=shared3/gm/browse.html&cat=372&amp;design=p3">Home &amp; Kitchen <span class="icon-chevron-right"></span></a></li>
					...
					<li><a href="http://www.hawkshop.com/ePOS/form=shared3/gm/browse.html&cat=49&amp;design=p3">Souvenirs <span class="icon-chevron-right"></span></a></li>
					<li><a href="http://www.hawkshop.com/ePOS/form=shared3/gm/browse.html&cat=68&amp;design=p3">Toys &amp; Games</a></li>
				</ul>
				<ul class="sub-nav-group">
					<li><h4 class="sub-nav-heading">Featured</h4></li>
